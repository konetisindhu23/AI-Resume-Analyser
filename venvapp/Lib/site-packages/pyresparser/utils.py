...
def extract_name(nlp_text, matcher):
    ...
    '''
    # Print the pattern to check if it's correctly formatted
    print("cs.NAME_PATTERN:", cs.NAME_PATTERN)

    # Ensure cs.NAME_PATTERN is a valid pattern (list of dictionaries)
    pattern = cs.NAME_PATTERN  # It should be a list of dicts

    # Add the pattern to the matcher
    matcher.add('NAME', [pattern])

    # Apply the matcher to the nlp_text
    matches = matcher(nlp_text)

    # Extract the name from the matches
